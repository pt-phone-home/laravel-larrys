...
@section('title')
Wood Cutting Specialists | Larry's DIY
@endsection

@section('content')
<div class="banner-small">

    <h1>Wood <span> Cutting </span></h1>

</div>

<div class="wood-heading-container">
    <div class="wood-heading">
        <h1>We specialise in custom wood cutting</h1>
        <p>We offer a wide range of specialist wood cutting services.</p>
    </div>
</div>

<div class="wood-1-container">
    <div class="wood-1">
        <div class="wood-1-img">
            <img src="/images/wood_cutting_1.jpg" alt="" class="">
        </div>
